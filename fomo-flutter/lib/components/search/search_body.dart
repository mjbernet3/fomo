                  ...
                  genreCards: [
                    GenreCard(
                      ...
                      genreImage: AssetImage(
                          "lib/assets/images/alternativedarkLOWQ.jpg"),
                      onPressed: () {
                    ...
                    GenreCard(
                      genreText: 'Country',
                      genreImage:
                          AssetImage("lib/assets/images/countrydarkLOWQ.jpg"),
                      onPressed: () {
                    ...
                    GenreCard(
                      genreText: 'Rock',
                      genreImage:
                          AssetImage("lib/assets/images/rockdarkLOWQ.jpg"),
                      onPressed: () {
                    ...
                    GenreCard(
                      genreText: 'Pop',
                      genreImage:
                          AssetImage("lib/assets/images/popdarkLOWQ.jpg"),
                      onPressed: () {
                    ...
                    GenreCard(
                      genreText: 'Hip-Hop',
                      genreImage:
                          AssetImage("lib/assets/images/hiphopdarkLOWQ.jpg"),
                      onPressed: () {
                    ...
                    GenreCard(
                      ...
                      genreImage: AssetImage(
                          "lib/assets/images/electronicdarkLOWQ.jpg"),
                      onPressed: () {
